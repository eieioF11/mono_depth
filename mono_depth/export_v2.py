...
from mono_depth.DepthAnythingV2.depth_anything_v2.dpt_trt import DepthAnythingV2

# model path
MODEL_PAHT = os.path.abspath(__file__.replace('export_v2.py', 'models'))
def main():
    ...
    onnx_path = MODEL_PAHT+f'/depth_anything_v2_{args.encoder}.onnx'
